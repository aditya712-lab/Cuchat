...
export default function Messenger({currentConversation,setCurrentConversation ,currentUser, socket, isOnline, unseenMessages, setUnseenMessages, conversation, setConversation, friends, setFriends, typingUser, setTypingUser}) {
      ...
      <>
        ...
        <div className="messenger-container">
          ...
          <div className='messenger-profile-header'>
            ...
            <img src={"../profiles/" + (currentConversation.groupPicture ? currentConversation.groupPicture : "default.jpg")} className='profile-image'></img>
              <div className='contact-info'>
              Group name : <br></br>
              <h2 className='group-name' onClick={ToggleSidebar}>
  ...
  <>
    ...
    <div className="messenger-container">
      ...
      <div className='messenger-profile-header'>
        <div className='messenger-profile-info'>
        <img src={"../profiles/" + user.profilePicture} className='profile-image'></img>
          <div className='contact-info'>
          <h2 className='contact-name' onClick={ToggleSidebar}>
            {user.username}
          </h2>
